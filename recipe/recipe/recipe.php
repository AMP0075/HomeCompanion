...
// get the average rate
	$query2="SELECT rid, round(AVG(rate),1) AS avgrate FROM Review GROUP BY rid HAVING rid = $rid" ;
...
<nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="index.php"> Welcome to RecipeZila!</a>
...
<?php } else{
  ...
  $max_per_column=$max_recipei/$max_column +1;
    ...
    <?php } ?>                   
    <ul>
         <li><?php echo "<img src= 'http://127.0.1.1/homecompanion/homecompanion.com/all/recipe/code/Images/".$MyPhoto."'height = 200/>";?></li>
  </ul>
    <?php if($rowCount % $max_per_column == $max_per_column -1) {  ?>
    </table></td> 
   	<?php } ?>                  
...
<h4 align="center"> Cuisine images using this recipe. (Try and submit your image too.)</h4>
<table>
<?php if ($numi2 == 0){?>
 <ul>
